...
| Library | n = 10 | n = 50 | n = 100 | 
| --- | --- | --- | --- |
| DLA | 3.400 μs | 20,176 | 2.377 ms |
| hmatrix | 1.179 μs | 20,936 | 297.6 μs |
| NumHask | 47.37 ms | 179,093,816 | 43.43 ms |
| Matrix | 10.84 μs | 392,288 | 8.329 ms |

#### QR factorization

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 3.050 μs | 40,248 | 2.375 ms |
| hmatrix | 68.20 μs | 9,074,048 | 46.28 ms |

#### Transpose

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 1.285 μs | 20,080 | 130.8 μs | 
| hmatrix | 12.02 ns | 64 | 11.93 ns | 
| NumHask | 9.356 μs | 0 | 8.424 μs | 
| Matrix | 2.267 μs | 239,952 | 355.8 μs | 
...
| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 197.0 ns | 16 | 20.10 μs |
| hmatrix | 89.56 ns | 232 | 181.7 ns |
| NumHask | 12.90 μs | 90,400 | 12.72 μs |

#### Row

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 16.01 ns | 64 | 17.05 ns |
| hmatrix | 704.6 ns | 2,128 | 739.7 ns |
| NumHask | 194.9 ns | 256 | 217.5 ns |
| Matrix | 42.94 ns | 20,112 | 340.5 ns |

#### Column

| Library | n = 10 | n = 50 | n = 100 | 
| --- | --- | --- | --- | 
| DLA | 38.04 ns | 480 | 195.2 ns |
| hmatrix | 817.4 ns | 2,128 | 1.078 μs |
| NumHask | 834.3 ns | 2,720 | 903.2 ns |
| Matrix | 222.0 ns | 23,744  | 1.954 μs |

#### Identity

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 90.64 ns | 20,528  | 2.841 μs |
| hmatrix | 1.804 μs | 66,440 | 150.9 μs |
| Matrix | 1.845 μs | 139,848 | 210.5 μs |
