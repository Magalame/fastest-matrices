...
| Library | n = 10 | n = 50 | n = 100 | 
| --- | --- | --- | --- |
| DLA | 376 | 20,176 | 80,176 |
| hmatrix | 904 | 20,936 | 80,936|
| NumHask | 179,093,816 | 179,093,816 | 179,093,816 |
| Matrix | 5,600 | 392,288 | 1,544,056 |

#### QR factorization

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 648 | 40,248 | 160,248 |
| hmatrix | 88,840 | 9,074,048 | 67,457,120 |

#### Transpose

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 280 | 20,080 | 80,080| 
| hmatrix | 64 | 64 | 64 | 
| NumHask | 0 | 0 | 0 | 
| Matrix | 2,680 | 239,952 | 959,664 | 
...
| Matrix | 688 | 23,744  | 87,400 |

#### Identity

| Library | n = 10 | n = 50 | n = 100 |
| --- | --- | --- | --- |
| DLA | 368 | 20,528  |80,928 |
| hmatrix | 1,408 | 66,440 | 252,440 |
| Matrix | 1,592 | 139,848 | 559,504 |
